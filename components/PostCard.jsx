...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="flex flex-col p-0 pb-12 mb-8 bg-white border rounded-lg shadow-md lg:p-8">
      <div className="p-4 mb-8 place-self-end">
      <Image src={NavLogo} alt="/"  width={120} height={14}  layout="fixed"
                 />
        {/* <img
      ...
      <h1 className="mb-8 text-xl font-semibold text-center transition duration-700 cursor-pointer hover:text-pink-600">
        <Link href={`/post/${post.id}`}>{post.title}</Link>
      </h1>
      <div className="items-center justify-between block w-full px-6 mb-8 text-center lg:flex">
      ...
      <p className="px-4 mb-8 text-lg font-normal text-center text-gray-700">
